...
from spacegame.hw05.hw05 import ICommand, IMovable, IRotable, MoveCmd, UObject, Vector
...
if __name__ == "__main__":
    ...
    print([m[0] for m in inspect.getmembers(movable_obj.__class__, inspect.isfunction)])

    rotable_obj = IoC.resolve("Adapter", IRotable, obj)
    rotable_obj.set_direction(2)
    print(rotable_obj.get_direction())
    print([m[0] for m in inspect.getmembers(rotable_obj.__class__, inspect.isfunction)])
